...
<ul class="nav nav-tabs">
    ...
    <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="{{ route('admin_post') }}">Посты</a>
    </li>
    <li class="nav-item">
            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('admin_post_ban') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method ('PUT')
                        <input type="hidden" name="address" value="admin_post">
                ...
                <td>
                    <a href="" data-bs-toggle="modal" {{-- в onclick для скрипта передаем значения, идут в форму модалки --}}
                        onclick="deliv('{{ $post->first_name }}','{{ $post->text }}','{{ $post->id }}')"
                ...
                <td>
                    <form method="POST" action="{{ route('post_del') }}">
                        ...
                        <input type="hidden" name="post_id"
                            value="{{ isset($post->id) ? $post->id : 'Правки поста' }}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin_post_update') }}" method="POST">
                    ...
                    <input type="hidden" name="post_id" id="in3" value="">
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Имя</label>
                        <input type="text" name="name" class="form-control" id="in1" value="" readonly>
